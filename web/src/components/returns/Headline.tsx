 ...
 * a year's rate, so the timing effect is too.
 */
export default function Headline({
  ...
  return (
    <dl className="grid gap-3 sm:grid-cols-3">
      <Stat testId="headline-twr" label="Rentabilidade (TWR)" note="O desempenho dos ativos, sem o efeito de quando você aportou.">
      ...
      <Stat testId="headline-xirr" label="Retorno do dinheiro (XIRR)" note="O retorno real, com a data e o valor de cada aporte e resgate.">
        <span data-testid="headline-value">{perYear(xirr)}</span>
      </Stat>

      <Stat testId="headline-timing" label="Efeito do timing" note="Quanto suas decisões de quando aportar ajudaram ou atrapalharam.">
